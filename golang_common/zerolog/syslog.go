...
func (sw syslogWriter) FormatCaller(i string) string {
	return defaultFormatCaller(i)
}

func (sw syslogWriter) FormatTimestamp() string {
	return defaultFormatTimestamp()
}

func (sw syslogWriter) FormatMessage(i string) string {
	return defaultFormatMessage(i)
}

func (sw syslogWriter) FormatLevel(i string) string {
